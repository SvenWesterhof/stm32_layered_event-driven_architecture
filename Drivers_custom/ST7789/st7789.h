...
/* Pin connection*/
#define ST7789_DC_PORT  spi_display_dc_GPIO_Port
#define ST7789_DC_PIN   spi_display_dc_Pin

#ifndef CFG_NO_CS
#define ST7789_CS_PORT  spi_display_cs_GPIO_Port
#define ST7789_CS_PIN   spi_display_cs_Pin
#endif

/* If u need Backlight control, uncomment below */
#define BLED_PORT spi_display_bled_GPIO_Port
#define BLED_PIN spi_display_bled_Pin
